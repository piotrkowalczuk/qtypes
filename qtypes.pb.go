...
package qtypes // import "github.com/piotrkowalczuk/qtypes"
...
func (QueryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_qtypes_bf65657b0c3e9166, []int{0}
}
...
func (*Int64) Descriptor() ([]byte, []int) {
	return fileDescriptor_qtypes_bf65657b0c3e9166, []int{1}
}
...
func (*Uint64) Descriptor() ([]byte, []int) {
	return fileDescriptor_qtypes_bf65657b0c3e9166, []int{2}
}
...
func (*Float64) Descriptor() ([]byte, []int) {
	return fileDescriptor_qtypes_bf65657b0c3e9166, []int{3}
}
...
type Timestamp struct {
	Values               []*timestamp.Timestamp `protobuf:"bytes,1,rep,name=values" json:"values,omitempty"`
	Valid                bool                   `protobuf:"varint,2,opt,name=valid" json:"valid,omitempty"`
	Negation             bool                   `protobuf:"varint,3,opt,name=negation" json:"negation,omitempty"`
	Type                 QueryType              `protobuf:"varint,4,opt,name=type,enum=qtypes.QueryType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
...
func (*Timestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_qtypes_bf65657b0c3e9166, []int{4}
}
...
func (m *Timestamp) GetValues() []*timestamp.Timestamp {
	if m != nil {
		return m.Values
	}
	return nil
...
func init() { proto.RegisterFile("qtypes.proto", fileDescriptor_qtypes_bf65657b0c3e9166) }

var fileDescriptor_qtypes_bf65657b0c3e9166 = []byte{
